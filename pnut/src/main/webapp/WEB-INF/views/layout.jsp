...
<div class="container">
    ...
    <div class="row">
    	<div class="col col-lg-2 col-md-3 col-sm-4 col-4"><tiles:insertAttribute name="menu"/></div>
    	<div class="col col-lg-10 col-md-9 col-sm-8 col-8"><tiles:insertAttribute name="body"/></div>
  	</div>  	
  </div>
</body>
</html>